...
import com.mee.manage.service.impl.FileHandleServiceImpl;
...
public class BigFileReader {
    ...
    public static final Logger logger = LoggerFactory.getLogger(BigFileReader.class);
    ...
    public static void main(String[] args) {
        ...
        IFileHandle fileHandle = new FileHandleServiceImpl();
        String bigFilePath = "C:/Users/BBbir/Downloads/lds-nz-street-address-CSV/nz-street-address.csv";
        BigFileReader.Builder builder = new BigFileReader.Builder(bigFilePath, fileHandle);
